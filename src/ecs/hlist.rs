...
impl<'a, LookupT, HeadT, TailT, IndexT> Pluck<LookupT, OnePlus<IndexT>> for &'a mut Cons<HeadT, TailT>
where
...
{
	type ListRest =
		<<Self as Pluck<NeedleHeadT, HeadIndicesT>>::Rest as PluckList<NeedleTailT, TailIndicesT>>::ListRest;
